...
namespace xt
{
    ...
    public:
        ...
        container_offset_view(const container_offset_view<E, OS, OE>& other)
        ...
        auto cend() const
        {
            if (End != -1)
            {
                return m_original_container.cbegin() + End;
            }
            else
            {
        ...
        auto rbegin() const
        {
            ...
            {
                return m_original_container.crbegin() + (static_cast<std::ptrdiff_t>(m_original_container.size()) - End);
            }
        }
